...
\begin{quote}
Find the number of \emph{Subscribers} and \emph{Customers} in every city
\end{quote}
...
{\color{incolor}In [{\color{incolor}4}]:} \PY{k}{def} \PY{n+nf}{time\PYZus{}of\PYZus{}trip}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            ...
            \PY{c+c1}{\PYZsh{} YOUR CODE HERE}
            \PY{k}{if} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Chicago}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                \PY{n}{datetime\PYZus{}object} \PY{o}{=} \PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{p}{(}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{starttime}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s1}{/}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{Y }\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{H:}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{M}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                \PY{n}{month} \PY{o}{=} \PY{n}{datetime\PYZus{}object}\PY{o}{.}\PY{n}{month}
                \PY{n}{hour} \PY{o}{=} \PY{n}{datetime\PYZus{}object}\PY{o}{.}\PY{n}{hour}
                \PY{n}{day\PYZus{}of\PYZus{}week} \PY{o}{=} \PY{n}{datetime\PYZus{}object}\PY{o}{.}\PY{n}{strftime}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{A}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
            ...
            \PY{k}{else}\PY{p}{:} 
                \PY{n}{datetime\PYZus{}object} \PY{o}{=} \PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{p}{(}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Start date}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s1}{/}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{Y }\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{H:}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{M}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                \PY{n}{month} \PY{o}{=} \PY{n}{datetime\PYZus{}object}\PY{o}{.}\PY{n}{month}
                \PY{n}{hour} \PY{o}{=} \PY{n}{datetime\PYZus{}object}\PY{o}{.}\PY{n}{hour}
                \PY{n}{day\PYZus{}of\PYZus{}week} \PY{o}{=} \PY{n}{datetime\PYZus{}object}\PY{o}{.}\PY{n}{strftime}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{A}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}5}]:} \PY{k}{def} \PY{n+nf}{type\PYZus{}of\PYZus{}user}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            ...
            \PY{k}{elif} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                \PY{n}{user\PYZus{}type} \PY{o}{=} \PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{usertype}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
            \PY{k}{else}\PY{p}{:}
                \PY{n}{t} \PY{o}{=} \PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Member Type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
                \PY{k}{if} \PY{n}{t} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Registered}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
...
{\color{incolor}In [{\color{incolor}10}]:} \PY{k}{def} \PY{n+nf}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
         ...
         \PY{k}{def} \PY{n+nf}{proportion\PYZus{}users}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
             \PY{n}{subscribers}\PY{p}{,} \PY{n}{customers}\PY{p}{,} \PY{n}{total} \PY{o}{=} \PY{n}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{filename}\PY{p}{)}
             
             \PY{n}{prop\PYZus{}subs} \PY{o}{=} \PY{n+nb}{round}\PY{p}{(}\PY{p}{(}\PY{n}{subscribers}\PY{o}{/}\PY{n}{total}\PY{p}{)}\PY{o}{*}\PY{l+m+mi}{100} \PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}
             \PY{n}{prop\PYZus{}cust} \PY{o}{=} \PY{n+nb}{round}\PY{p}{(}\PY{p}{(}\PY{n}{customers}\PY{o}{/}\PY{n}{total}\PY{p}{)}\PY{o}{*}\PY{l+m+mi}{100} \PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}
             \PY{k}{return} \PY{p}{(}\PY{n}{prop\PYZus{}subs}\PY{p}{,}\PY{n}{prop\PYZus{}cust}\PY{p}{)}
         
         \PY{n}{data\PYZus{}NYC} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
         \PY{n}{data\PYZus{}Washington} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
         \PY{n}{data\PYZus{}Chicago} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Chicago\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Modify this and the previous cell to answer Question 4a. Remember to run \PYZsh{}\PYZsh{}}
         ...
         \PY{n}{temp1} \PY{o}{=} \PY{n}{proportion\PYZus{}users}\PY{p}{(}\PY{n}{data\PYZus{}NYC}\PY{p}{)}
         \PY{n}{t1}\PY{o}{=}\PY{n}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{data\PYZus{}NYC}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{NYC: }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{data\PYZus{}NYC}\PY{p}{)}\PY{p}{)}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Proportion of Subscribers of NYC: }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{ Proportion of Customers of NYC: }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{ }\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{temp1}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,}\PY{n}{temp1}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{)}
         
         \PY{n}{temp2} \PY{o}{=} \PY{n}{proportion\PYZus{}users}\PY{p}{(}\PY{n}{data\PYZus{}Washington}\PY{p}{)}
         \PY{n}{t2}\PY{o}{=}\PY{n}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{data\PYZus{}Washington}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Washington: }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{data\PYZus{}Washington}\PY{p}{)}\PY{p}{)}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Proportion of Subscribers of Washington: }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{ Proportion of Customers of Washington: }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{ }\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{temp2}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,}\PY{n}{temp2}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{)}
         
         \PY{n}{temp3} \PY{o}{=} \PY{n}{proportion\PYZus{}users}\PY{p}{(}\PY{n}{data\PYZus{}Chicago}\PY{p}{)}
         \PY{n}{t3}\PY{o}{=}\PY{n}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{data\PYZus{}Chicago}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Chicago: }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{data\PYZus{}Chicago}\PY{p}{)}\PY{p}{)}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Proportion of Subscribers of Chicago: }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{ Proportion of Customers of Chicago: }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{ }\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{temp3}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,}\PY{n}{temp3}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{)}
         \PY{n}{max\PYZus{}s}\PY{o}{=}\PY{l+m+mi}{0}
         \PY{k}{if}\PY{p}{(}\PY{n}{temp1}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{\PYZgt{}}\PY{n}{temp2}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{:}
             \PY{n}{max\PYZus{}s}\PY{o}{=}\PY{n}{temp1}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
             \PY{n}{city\PYZus{}s}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}
         \PY{k}{else}\PY{p}{:}
             \PY{n}{max\PYZus{}s}\PY{o}{=}\PY{n}{temp2}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
             \PY{n}{city\PYZus{}s}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington}\PY{l+s+s1}{\PYZsq{}}
         \PY{k}{if}\PY{p}{(}\PY{n}{temp3}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{\PYZgt{}}\PY{n}{max\PYZus{}s}\PY{p}{)}\PY{p}{:}
             \PY{n}{max\PYZus{}s}\PY{o}{=}\PY{n}{temp3}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
             \PY{n}{city\PYZus{}s}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Chicago}\PY{l+s+s1}{\PYZsq{}}
         \PY{n}{max\PYZus{}c}\PY{o}{=}\PY{l+m+mi}{0}
         \PY{k}{if}\PY{p}{(}\PY{n}{temp1}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{o}{\PYZgt{}}\PY{n}{temp2}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{:}
             \PY{n}{max\PYZus{}c}\PY{o}{=}\PY{n}{temp1}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
             \PY{n}{city\PYZus{}c}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}
         \PY{k}{else}\PY{p}{:}
             \PY{n}{max\PYZus{}c}\PY{o}{=}\PY{n}{temp2}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
             \PY{n}{city\PYZus{}c}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington}\PY{l+s+s1}{\PYZsq{}}
         \PY{k}{if}\PY{p}{(}\PY{n}{temp3}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{o}{\PYZgt{}}\PY{n}{max\PYZus{}s}\PY{p}{)}\PY{p}{:}
             \PY{n}{max\PYZus{}c}\PY{o}{=}\PY{n}{temp3}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
             \PY{n}{city\PYZus{}c}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Chicago}\PY{l+s+s1}{\PYZsq{}}
             
         \PY{k}{if}\PY{p}{(}\PY{n}{t1}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{o}{\PYZgt{}}\PY{n}{t2}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{)}\PY{p}{:}
             \PY{n}{max\PYZus{}n}\PY{o}{=}\PY{n}{t1}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}
             \PY{n}{city}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}
         \PY{k}{else}\PY{p}{:}
             \PY{n}{max\PYZus{}n}\PY{o}{=}\PY{n}{t2}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}
             \PY{n}{city}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington}\PY{l+s+s1}{\PYZsq{}}
         \PY{k}{if}\PY{p}{(}\PY{n}{t3}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{o}{\PYZgt{}}\PY{n}{max\PYZus{}n}\PY{p}{)}\PY{p}{:}
             \PY{n}{max\PYZus{}n}\PY{o}{=}\PY{n}{t3}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}
             \PY{n}{city}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Chicago}\PY{l+s+s1}{\PYZsq{}}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{highest number of trips is in }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{ city with a total of }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{city}\PY{p}{,}\PY{n}{max\PYZus{}n}\PY{p}{)}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{highest proportion of trips made by subscribers is in }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{ city with proportion }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{city\PYZus{}s}\PY{p}{,}\PY{n}{max\PYZus{}s}\PY{p}{)}\PY{p}{)} 
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{highest proportion of trips made by short\PYZhy{}term customers is in }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{ city with proportion }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{city\PYZus{}c}\PY{p}{,}\PY{n}{max\PYZus{}c}\PY{p}{)}\PY{p}{)} 
\end{Verbatim}
...
\textbf{Answer}: Replace this text with your reponse!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 4b.                 \PYZsh{}\PYZsh{}}
         ...
         \PY{k}{def} \PY{n+nf}{avg\PYZus{}trip\PYZus{}length}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 ...
                 \PY{n}{total\PYZus{}trip\PYZus{}len} \PY{o}{=} \PY{l+m+mi}{0}
                 \PY{n}{number\PYZus{}long\PYZus{}trips} \PY{o}{=} \PY{l+m+mi}{0}
                 
                 \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                     \PY{n}{total\PYZus{}trip\PYZus{}len} \PY{o}{+}\PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
                     \PY{k}{if}\PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)} \PY{o}{\PYZgt{}} \PY{l+m+mi}{30}\PY{p}{)}\PY{p}{:}
                         \PY{n}{number\PYZus{}long\PYZus{}trips} \PY{o}{+}\PY{o}{=}\PY{l+m+mi}{1}
                 \PY{n}{total\PYZus{}trips} \PY{o}{=} \PY{n}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{filename}\PY{p}{)}
                 
                 \PY{n}{avg\PYZus{}trip} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n}{total\PYZus{}trip\PYZus{}len} \PY{o}{/} \PY{n}{total\PYZus{}trips}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{)}
                 \PY{n}{proportion} \PY{o}{=} \PY{p}{(}\PY{n}{number\PYZus{}long\PYZus{}trips} \PY{o}{/} \PY{n}{total\PYZus{}trips}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{)} \PY{o}{*} \PY{l+m+mi}{100}
             \PY{k}{return} \PY{n}{avg\PYZus{}trip}\PY{p}{,} \PY{n+nb}{round}\PY{p}{(}\PY{n}{proportion}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}
         
         \PY{n}{data\PYZus{}Washington} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
         \PY{n}{data\PYZus{}Chicago} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Chicago\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
         \PY{n}{data\PYZus{}NYC} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
         
         \PY{n}{temp}\PY{o}{=}\PY{n}{avg\PYZus{}trip\PYZus{}length}\PY{p}{(}\PY{n}{data\PYZus{}Washington}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Avg trip length of Washington: }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{, Proportion of long trips: }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{temp}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,}\PY{n}{temp}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{)}
         
         \PY{n}{temp}\PY{o}{=}\PY{n}{avg\PYZus{}trip\PYZus{}length}\PY{p}{(}\PY{n}{data\PYZus{}Chicago}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Avg trip length of Chicago: }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{, Proportion of long trips: }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{temp}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,}\PY{n}{temp}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{)}
         
         \PY{n}{temp}\PY{o}{=}\PY{n}{avg\PYZus{}trip\PYZus{}length}\PY{p}{(}\PY{n}{data\PYZus{}NYC}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Avg trip length of NYC: }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{, Proportion of long trips: }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{temp}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,}\PY{n}{temp}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
\textbf{Answer}: Replace this text with your response!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 4c. If you have    \PYZsh{}\PYZsh{}}
         ...
         \PY{k}{def} \PY{n+nf}{ans}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 \PY{n}{Reader} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}
                 
                 \PY{n}{subs\PYZus{}duration} \PY{o}{=} \PY{l+m+mi}{0}
                 \PY{n}{cust\PYZus{}duration} \PY{o}{=} \PY{l+m+mi}{0}
                 
                 \PY{k}{for} \PY{n}{r} \PY{o+ow}{in} \PY{n}{Reader}\PY{p}{:}
                     \PY{k}{if} \PY{n}{r}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                         \PY{n}{subs\PYZus{}duration} \PY{o}{+}\PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{r}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
                     \PY{k}{else}\PY{p}{:}
                         \PY{n}{cust\PYZus{}duration} \PY{o}{+}\PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{r}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
                 \PY{n}{total\PYZus{}trips}\PY{o}{=} \PY{n}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{filename}\PY{p}{)}
                 
                 \PY{n}{avg\PYZus{}trip\PYZus{}duration\PYZus{}subs} \PY{o}{=} \PY{p}{(}\PY{n}{subs\PYZus{}duration} \PY{o}{/} \PY{n}{total\PYZus{}trips}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}
                 \PY{n}{avg\PYZus{}trip\PYZus{}duration\PYZus{}cust} \PY{o}{=} \PY{p}{(}\PY{n}{cust\PYZus{}duration} \PY{o}{/} \PY{n}{total\PYZus{}trips}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
             \PY{k}{return} \PY{n+nb}{round}\PY{p}{(}\PY{n}{avg\PYZus{}trip\PYZus{}duration\PYZus{}subs}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}\PY{p}{,} \PY{n+nb}{round}\PY{p}{(}\PY{n}{avg\PYZus{}trip\PYZus{}duration\PYZus{}cust}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}
         \PY{n}{data\PYZus{}Washington} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
         
         
         \PY{n}{temp}\PY{o}{=}\PY{n}{ans}\PY{p}{(}\PY{n}{data\PYZus{}Washington}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{City:Washington , Avg trip duration Subscribers: }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ , Avg trip duration Customers: }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{temp}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,}\PY{n}{temp}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{)}
         \PY{k}{if}\PY{p}{(}\PY{n}{temp}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{\PYZgt{}}\PY{n}{temp}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{:}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Subscribers take longest rides}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{;}
         \PY{k}{else}\PY{p}{:}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Customers take longest rides}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
...
library and to generate an example plot.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{c+c1}{\PYZsh{} load library}
...
{\color{incolor}In [{\color{incolor}15}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to collect all of the trip times as a list \PYZsh{}\PYZsh{}}
         ...
         \PY{k}{def} \PY{n+nf}{plot\PYZus{}graph}\PY{p}{(}\PY{n}{filename}\PY{p}{,}\PY{n}{city}\PY{p}{)}\PY{p}{:}
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 \PY{n}{reader} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}
                 
                 \PY{n}{data} \PY{o}{=} \PY{p}{[}\PY{p}{]}
                 \PY{k}{for} \PY{n}{r} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                     \PY{n}{data}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n+nb}{round}\PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{n}{r}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{data}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{histogram of the trip times for }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{ }\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{city}\PY{p}{)}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration (m)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
         ...
         \PY{n}{plot\PYZus{}graph}\PY{p}{(}\PY{n}{data\PYZus{}Washington}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
...
\textbf{Answer}: Replace this text with your response!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}36}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 5. \PYZsh{}\PYZsh{}}
         \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k}{as} \PY{n+nn}{np}
         \PY{k+kn}{import} \PY{n+nn}{seaborn} \PY{k}{as} \PY{n+nn}{sns}
         \PY{k}{def} \PY{n+nf}{plot\PYZus{}subs}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 \PY{n}{reader} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}
                 \PY{n}{data} \PY{o}{=} \PY{p}{[}\PY{p}{]}
                 ...
                 \PY{k}{for} \PY{n}{r} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                     \PY{k}{if} \PY{n}{r}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                         \PY{n}{data}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n+nb}{round}\PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{n}{r}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)}
             \PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{,}\PY{n}{\PYZus{}}\PY{o}{=}\PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{data}\PY{p}{,} \PY{n}{bins}\PY{o}{=} \PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{10}\PY{p}{,} \PY{l+m+mi}{15}\PY{p}{,} \PY{l+m+mi}{20}\PY{p}{,} \PY{l+m+mi}{25}\PY{p}{,} \PY{l+m+mi}{30}\PY{p}{,} \PY{l+m+mi}{35}\PY{p}{,} \PY{l+m+mi}{40}\PY{p}{,} \PY{l+m+mi}{45}\PY{p}{,} \PY{l+m+mi}{50}\PY{p}{,} \PY{l+m+mi}{55}\PY{p}{,} \PY{l+m+mi}{60}\PY{p}{,} \PY{l+m+mi}{65}\PY{p}{,} \PY{l+m+mi}{70}\PY{p}{,} \PY{l+m+mi}{75}\PY{p}{]}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{xticks}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{76}\PY{p}{,} \PY{l+m+mf}{5.0}\PY{p}{)}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Plot of Trip Durations of Subscribers in }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{city}\PY{p}{)}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration (m)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Peak value of the distribution is }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{x}\PY{o}{.}\PY{n}{max}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{p}{)}
             
         \PY{n}{data\PYZus{}Washington} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
         \PY{n}{plot\PYZus{}subs}\PY{p}{(}\PY{n}{data\PYZus{}Washington}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
Peak value of the distribution is 17705.0
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{k}{def} \PY{n+nf}{plot\PYZus{}cust}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 \PY{n}{reader} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}
                 \PY{n}{data} \PY{o}{=} \PY{p}{[}\PY{p}{]}
                 
                 \PY{k}{for} \PY{n}{r} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                     \PY{k}{if} \PY{n}{r}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customer}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                         \PY{n}{data}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n+nb}{round}\PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{n}{r}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{data}\PY{p}{,} \PY{n}{bins}\PY{o}{=} \PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{10}\PY{p}{,} \PY{l+m+mi}{15}\PY{p}{,} \PY{l+m+mi}{20}\PY{p}{,} \PY{l+m+mi}{25}\PY{p}{,} \PY{l+m+mi}{30}\PY{p}{,} \PY{l+m+mi}{35}\PY{p}{,} \PY{l+m+mi}{40}\PY{p}{,} \PY{l+m+mi}{45}\PY{p}{,} \PY{l+m+mi}{50}\PY{p}{,} \PY{l+m+mi}{55}\PY{p}{,} \PY{l+m+mi}{60}\PY{p}{,} \PY{l+m+mi}{65}\PY{p}{,} \PY{l+m+mi}{70}\PY{p}{,} \PY{l+m+mi}{75}\PY{p}{]}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{xticks}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{76}\PY{p}{,} \PY{l+m+mf}{5.0}\PY{p}{)}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Plot of Trip Durations of Customers in }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{city}\PY{p}{)}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration (m)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
             
         \PY{n}{data\PYZus{}Washington} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
         \PY{n}{plot\PYZus{}cust}\PY{p}{(}\PY{n}{data\PYZus{}Washington}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
visualization below!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to continue to explore the dataset. \PYZsh{}\PYZsh{}}
         ...
         \PY{c+c1}{\PYZsh{}\PYZsh{} viewed the example from github}
         
         \PY{k+kn}{import} \PY{n+nn}{calendar}
         \PY{k}{def} \PY{n+nf}{per\PYZus{}day\PYZus{}ana}\PY{p}{(}\PY{n}{filename}\PY{p}{,}\PY{n}{city}\PY{p}{,}\PY{n}{usertype}\PY{p}{)}\PY{p}{:}
             \PY{k}{if} \PY{n}{usertype} \PY{o+ow}{not} \PY{o+ow}{in} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customer}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{:}
                 \PY{k}{return} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{user does not exist}\PY{l+s+s2}{\PYZdq{}}
             \PY{n}{user\PYZus{}each\PYZus{}day}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}
             \PY{n}{user\PYZus{}weekdays}\PY{o}{=} \PY{l+m+mi}{0}
             \PY{n}{user\PYZus{}weekends}\PY{o}{=} \PY{l+m+mi}{0}
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 \PY{n}{reader} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}
                 \PY{k}{for} \PY{n}{r} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                     \PY{k}{if} \PY{n}{r}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{n}{usertype}\PY{p}{:}
                         \PY{k}{if} \PY{n}{r}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day\PYZus{}of\PYZus{}week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Monday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                             \PY{n}{user\PYZus{}each\PYZus{}day}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{+}\PY{o}{=}\PY{l+m+mi}{1}
                             \PY{n}{user\PYZus{}weekdays} \PY{o}{+}\PY{o}{=}\PY{l+m+mi}{1}
                         \PY{k}{elif} \PY{n}{r}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day\PYZus{}of\PYZus{}week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Tuesday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                             \PY{n}{user\PYZus{}each\PYZus{}day}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]} \PY{o}{+}\PY{o}{=}\PY{l+m+mi}{1}
                             \PY{n}{user\PYZus{}weekdays} \PY{o}{+}\PY{o}{=}\PY{l+m+mi}{1}
                         \PY{k}{elif}  \PY{n}{r}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day\PYZus{}of\PYZus{}week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Wednesday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                             \PY{n}{user\PYZus{}each\PYZus{}day}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]} \PY{o}{+}\PY{o}{=}\PY{l+m+mi}{1}
                             \PY{n}{user\PYZus{}weekdays} \PY{o}{+}\PY{o}{=}\PY{l+m+mi}{1}
                         \PY{k}{elif}  \PY{n}{r}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day\PYZus{}of\PYZus{}week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Thursday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                             \PY{n}{user\PYZus{}each\PYZus{}day}\PY{p}{[}\PY{l+m+mi}{3}\PY{p}{]} \PY{o}{+}\PY{o}{=}\PY{l+m+mi}{1}
                             \PY{n}{user\PYZus{}weekdays} \PY{o}{+}\PY{o}{=}\PY{l+m+mi}{1}
                         \PY{k}{elif}  \PY{n}{r}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day\PYZus{}of\PYZus{}week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Friday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                             \PY{n}{user\PYZus{}each\PYZus{}day}\PY{p}{[}\PY{l+m+mi}{4}\PY{p}{]} \PY{o}{+}\PY{o}{=}\PY{l+m+mi}{1}
                             \PY{n}{user\PYZus{}weekdays} \PY{o}{+}\PY{o}{=}\PY{l+m+mi}{1}
                         \PY{k}{elif}  \PY{n}{r}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day\PYZus{}of\PYZus{}week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Saturday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                             \PY{n}{user\PYZus{}each\PYZus{}day}\PY{p}{[}\PY{l+m+mi}{5}\PY{p}{]} \PY{o}{+}\PY{o}{=}\PY{l+m+mi}{1}
                             \PY{n}{user\PYZus{}weekends} \PY{o}{+}\PY{o}{=}\PY{l+m+mi}{1}
                         \PY{k}{elif}  \PY{n}{r}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day\PYZus{}of\PYZus{}week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Sunday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                             \PY{n}{user\PYZus{}each\PYZus{}day}\PY{p}{[}\PY{l+m+mi}{6}\PY{p}{]} \PY{o}{+}\PY{o}{=}\PY{l+m+mi}{1}
                             \PY{n}{user\PYZus{}weekends} \PY{o}{+}\PY{o}{=}\PY{l+m+mi}{1}
             \PY{n}{day\PYZus{}sys\PYZus{}max\PYZus{}use} \PY{o}{=} \PY{n}{calendar}\PY{o}{.}\PY{n}{day\PYZus{}name}\PY{p}{[}\PY{n}{user\PYZus{}each\PYZus{}day}\PY{o}{.}\PY{n}{index}\PY{p}{(}\PY{n+nb}{max}\PY{p}{(}\PY{n}{user\PYZus{}each\PYZus{}day}\PY{p}{)}\PY{p}{)}\PY{p}{]}
             \PY{n}{x}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mi}{7}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{user\PYZus{}each\PYZus{}day}\PY{p}{,} \PY{l+m+mf}{0.5}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{xticks}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Mon}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Tue}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Wed}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Thu}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Fri}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Sat}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Sun}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Ridership on various days of week for }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{s in }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{usertype}\PY{p}{,}\PY{n}{city}\PY{p}{)}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Day of week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Ridership}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
             
             \PY{k}{if}\PY{p}{(}\PY{n}{user\PYZus{}weekdays} \PY{o}{\PYZgt{}} \PY{n}{user\PYZus{}weekends}\PY{p}{)}\PY{p}{:}
                 \PY{k}{return} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{For }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{: Ridership was greater on Weekdays}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{usertype}\PY{p}{)}
             \PY{k}{else}\PY{p}{:}
                 \PY{k}{return} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{For }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{: Ridership was greater on Weekends}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{usertype}\PY{p}{)}
         
         \PY{n}{data\PYZus{}Washington} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
         \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{}data\PYZus{}Chicago = \PYZsq{}./data/Chicago\PYZhy{}2016\PYZhy{}Summary.csv\PYZsq{}}
         \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{}data\PYZus{}NYC = \PYZsq{}./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv\PYZsq{}}
         
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{per\PYZus{}day\PYZus{}ana}\PY{p}{(}\PY{n}{data\PYZus{}Washington}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{per\PYZus{}day\PYZus{}ana}\PY{p}{(}\PY{n}{data\PYZus{}Washington}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customer}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
         \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{}print(per\PYZus{}day\PYZus{}ana(data\PYZus{}Chicago, \PYZsq{}Chicago\PYZsq{}, \PYZsq{}Subscriber\PYZsq{}))}
         \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{}print(per\PYZus{}day\PYZus{}ana(data\PYZus{}Washington, \PYZsq{}Washington\PYZsq{}, \PYZsq{}Customer\PYZsq{}))}
         \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{}print(per\PYZus{}day\PYZus{}ana(data\PYZus{}NYC, \PYZsq{}NYC\PYZsq{}, \PYZsq{}Subscriber\PYZsq{}))}
         \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{}print(per\PYZus{}day\PYZus{}ana(data\PYZus{}NYC, \PYZsq{}NYC\PYZsq{}, \PYZsq{}Customer\PYZsq{}))}
\end{Verbatim}
...
\end{quote}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{k+kn}{from} \PY{n+nn}{subprocess} \PY{k}{import} \PY{n}{call}
...
\end{Verbatim}
    ...
    \paragraph{Application of data
science:}\label{application-of-data-science}

Data science acan be used for analysis of voting where we could find
dataset with the list of information.We can plot the information and
find the cities having maximum votes for a givenparty or we can find the
proportion of votes in vevery region and compare them. We cana also plot
the number of votes and find the growth of voting along the decade.
